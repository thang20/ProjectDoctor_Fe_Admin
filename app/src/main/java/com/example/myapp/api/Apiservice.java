...
public interface Apiservice {
    ...
    @POST("activedoctor")
    Call<ResponseBody> activedoctor(@Body RequestBody user);
    @POST("allthuoc")
    Call<ResponseBody> allthuoc(@Body RequestBody user);
    @POST("postacommentdt")
    Call<ResponseBody> postacommentdt(@Body RequestBody user);
    @POST("allcommentdt")
    Call<ResponseBody> allcommentdt(@Body RequestBody user);
    @POST("xraydt")
    Call<ResponseBody> xraydt(@Body RequestBody user);
    @POST("skindt")
    Call<ResponseBody> skindt(@Body RequestBody user);
    @POST("alllichdt")
    Call<ResponseBody> alllichdt(@Body RequestBody user);
    @POST("takeserviceofspec")
    Call<ResponseBody> takeserviceofspec(@Body RequestBody user);
    @POST("createex")
    Call<ResponseBody> createex(@Body RequestBody user);
    @POST("alllichdtthuoc")
    Call<ResponseBody> alllichdtthuoc(@Body RequestBody user);
    @POST("takeallthuoc")
    Call<ResponseBody> takeallthuoc(@Body RequestBody user);
    @POST("ktkethuoc")
    Call<ResponseBody> ktkethuoc(@Body RequestBody user);
    @POST("turnoncall")
    Call<ResponseBody> turnoncall(@Body RequestBody user);
    @POST("turnoffcall")
    Call<ResponseBody> turnoffcall(@Body RequestBody user);
    @POST("addhospital")
    Call<ResponseBody> addhospital(@Body RequestBody user);
    @POST("deletehospital")
    Call<ResponseBody> deletehospital(@Body RequestBody user);
    @POST("allclient")
    Call<ResponseBody> allclient(@Body RequestBody user);
    @POST("alldoctor")
    Call<ResponseBody> alldoctor(@Body RequestBody user);
    @POST("alllichathome")
    Call<ResponseBody> alllichathome(@Body RequestBody user);
    @POST("alldoctorfree")
    Call<ResponseBody> alldoctorfree(@Body RequestBody user);
    @POST("testhomefinish")
    Call<ResponseBody> testhomefinish(@Body RequestBody user);
    @POST("healcv")
    Call<ResponseBody> healcv(@Body RequestBody user);
    @POST("adminregister")
    Call<ResponseBody> adminregister(@Body RequestBody user);
    @POST("adminlogin")
    Call<ResponseBody> adminlogin(@Body RequestBody user);
    @POST("allgift")
    Call<ResponseBody> allgift(@Body RequestBody user);
    @POST("deletegift")
    Call<ResponseBody> deletegift(@Body RequestBody user);
    @POST("addgift")
    Call<ResponseBody> addgift(@Body RequestBody user);
    @POST("allserviceadmin")
    Call<ResponseBody> allserviceadmin(@Body RequestBody user);
    @POST("deleteservice")
    Call<ResponseBody> deleteservice(@Body RequestBody user);
    @POST("addservice")
    Call<ResponseBody> addservice(@Body RequestBody user);
    @POST("allcontribute")
    Call<ResponseBody> allcontribute(@Body RequestBody user);

...
public class ItemNewAtHome implements Parcelable  {
    private String name, td, image, active, address, gender, phone, age, date, time, idl, idclient;



    protected ItemNewAtHome(Parcel in) {
        name = in.readString();
        td = in.readString();
        image = in.readString();
    ...
    public ItemNewAtHome(String name, String td, String image, String active, String address,
                         String gender, String phone, String age, String date, String time,
                         String idl, String idclient) {
        this.name = name;
        this.td = td;
        this.image = image;
        this.active = active;
